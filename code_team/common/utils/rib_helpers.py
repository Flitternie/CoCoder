"""Shared helpers for tools that operate on RIB architecture JSON."""
...
def flatten_files(architecture: list[dict]) -> list[dict]:
    """Extract a flat list of file items from RIB architecture."""
    files = []
